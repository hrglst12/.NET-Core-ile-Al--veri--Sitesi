...
namespace Site.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser = _db.ApplicationUser.FirstOrDefault(i => i.Id == claim.Value);
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            var user = _db.ApplicationUser.FirstOrDefault(i => i.Id == claim.Value);
            if(user == null)
            {
